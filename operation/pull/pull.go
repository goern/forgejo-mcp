...
func GetPullRequestByIndexFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	pr, _, err := forgejo.Client(ctx).GetPullRequest(owner, repo, int64(index))
	if err != nil {
...
func ListRepoPullRequestsFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	prs, _, err := forgejo.Client(ctx).ListRepoPullRequests(owner, repo, opt)
	if err != nil {
...
func CreatePullRequestFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	pr, _, err := forgejo.Client(ctx).CreatePullRequest(owner, repo, opt)
	if err != nil {
...
func UpdatePullRequestFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	pr, _, err := forgejo.Client(ctx).EditPullRequest(owner, repo, int64(index), opt)
	if err != nil {
...
func ListPullReviewsFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	reviews, _, err := forgejo.Client(ctx).ListPullReviews(owner, repo, int64(index), opt)
	if err != nil {
...
func GetPullReviewFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	review, _, err := forgejo.Client(ctx).GetPullReview(owner, repo, int64(index), int64(id))
	if err != nil {
...
func MergePullRequestFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	merged, resp, err := forgejo.Client(ctx).MergePullRequest(owner, repo, int64(index), opt)
	if err != nil {
...
func ListPullRequestFilesFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	files, _, err := forgejo.Client(ctx).ListPullRequestFiles(owner, repo, int64(index), opt)
	if err != nil {
...
func GetPullRequestDiffFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	diffBytes, _, err := forgejo.Client(ctx).GetPullRequestDiff(owner, repo, int64(index), forgejo_sdk.PullRequestDiffOptions{})
	if err != nil {
...
func ListPullReviewCommentsFn(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	comments, _, err := forgejo.Client(ctx).ListPullReviewComments(owner, repo, int64(index), int64(id))
	if err != nil {
